...
- `/build-image` *(admin)* — attache une capture à une fiche, au choix **Mods** ou **Éclats d'Archonte**. **Ni les mods ni les éclats ne sont retranscrits en texte** : ce sont les captures qui les portent, avec rangs, polarités et tauforge. Les deux s'affichent dans le même message ; tant qu'une capture manque, la fiche l'indique.
